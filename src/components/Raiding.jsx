...
function Raiding() {
  return (
    <section id="raiding" className="raiding-section">
      <h1>Raiding</h1>
      <div>
        <div className="raiding-description">
          <p>
            ...
            and raid assignments, and compile essential weakauras/macros. All
            raid preparations are shared in advance, allowing even our busiest
            raiders ample time to review them befors the raid. This approach
